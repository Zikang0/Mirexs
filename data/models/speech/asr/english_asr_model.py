...
class EnglishASRModel:
    ...
    def load(self, model_path: Optional[str] = None) -> bool:
        ...
        try:
            ...
            try:
                ...
                model_name = "facebook/wav2vec2-base-960h"  # 英文预训练模型
                ...
                self.is_loaded = True
                print(f"✅ 英文ASR模型加载成功: {model_name}")
                return True
    ...
    def transcribe(self, audio_data: np.ndarray, sample_rate: int = 16000) -> Dict[str, Any]:
        ...
        try:
            ...
            # 后处理文本
            transcription = self._postprocess_text(transcription)
    ...
    def set_language_model(self, enabled: bool = True) -> None:
        """启用/禁用语言模型"""
